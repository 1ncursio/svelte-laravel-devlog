...
async function createInertiaApp({ id = 'app', resolve, setup, page, render }) {
  ...
  const svelteApp = await resolveComponent(initialPage.component).then(initialComponent => {
    return setup({
      el,
      App: (_App_svelte__WEBPACK_IMPORTED_MODULE_0___default()),
      props: {
        initialPage,
        initialComponent,
        resolveComponent,
...
/* harmony export */   "App": () => (/* reexport default from dynamic */ _App_svelte__WEBPACK_IMPORTED_MODULE_5___default.a),
/* harmony export */   "InertiaApp": () => (/* reexport default from dynamic */ _App_svelte__WEBPACK_IMPORTED_MODULE_5___default.a),
/* harmony export */   "app": () => (/* reexport default from dynamic */ _App_svelte__WEBPACK_IMPORTED_MODULE_5___default.a),
/* harmony export */   "Link": () => (/* reexport default from dynamic */ _InertiaLink_svelte__WEBPACK_IMPORTED_MODULE_6___default.a),
/* harmony export */   "InertiaLink": () => (/* reexport default from dynamic */ _InertiaLink_svelte__WEBPACK_IMPORTED_MODULE_6___default.a),
/* harmony export */   "link": () => (/* reexport default from dynamic */ _InertiaLink_svelte__WEBPACK_IMPORTED_MODULE_6___default.a)
/* harmony export */ });
...
/* harmony import */ var _App_svelte__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_App_svelte__WEBPACK_IMPORTED_MODULE_5__);
...
/* harmony import */ var _InertiaLink_svelte__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_InertiaLink_svelte__WEBPACK_IMPORTED_MODULE_6__);
...
/* harmony export */ });
Object(function webpackMissingModule() { var e = new Error("Cannot find module 'svelte'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((node, options = {}) => {
  ...
  const dispatch = Object(function webpackMissingModule() { var e = new Error("Cannot find module 'svelte'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())()
...
Object(function webpackMissingModule() { var e = new Error("Cannot find module 'svelte/store'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());



const page = Object(function webpackMissingModule() { var e = new Error("Cannot find module 'svelte/store'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(_store__WEBPACK_IMPORTED_MODULE_0__["default"], $store => $store.page)
...
const store = Object(function webpackMissingModule() { var e = new Error("Cannot find module 'svelte/store'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())({
  component: null,
  layout: [],
  page: {},
  key: null,
...
function useRemember(initialState, key) {
  ...
  const store = Object(function webpackMissingModule() { var e = new Error("Cannot find module 'svelte/store'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(restored !== undefined ? restored : initialState)
  const unsubscribe = store.subscribe(state => _inertiajs_inertia__WEBPACK_IMPORTED_MODULE_1__.Inertia.remember(state, key))

  Object(function webpackMissingModule() { var e = new Error("Cannot find module 'svelte'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(unsubscribe)
...
var map = {
	"./posts/index.svelte": "./resources/js/Pages/posts/index.svelte"
};
